...
import ElisionIoElisionElisionioElisionDex from './elision-io/elision/elisionio.elision.dex'
...
export default { 
  ...
  ElisionIoElisionElisionioElisionDex: load(ElisionIoElisionElisionioElisionDex, 'elisionio.elision.dex'),
