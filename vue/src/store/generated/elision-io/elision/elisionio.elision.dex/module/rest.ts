...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/elision-io/elision/dex/buy_order_book
   */
  queryBuyOrderBookAll = (
    ...
    this.request<DexQueryAllBuyOrderBookResponse, RpcStatus>({
      path: `/elision-io/elision/dex/buy_order_book`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/elision-io/elision/dex/denom_trace
   */
  queryDenomTraceAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<DexQueryAllDenomTraceResponse, RpcStatus>({
      path: `/elision-io/elision/dex/denom_trace`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/elision-io/elision/dex/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<DexQueryParamsResponse, RpcStatus>({
      path: `/elision-io/elision/dex/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/elision-io/elision/dex/sell_order_book
   */
  querySellOrderBookAll = (
    ...
    this.request<DexQueryAllSellOrderBookResponse, RpcStatus>({
      path: `/elision-io/elision/dex/sell_order_book`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
